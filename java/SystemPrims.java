...
class SystemPrims extends Primitives {
  ...
  public Object dispatch(int offset, Object[] args, LContext lc){
    switch(offset){
      ...
      case 20: return prim_getProperty(args[0], lc);
      case 21: return null;   // ignore
      case 22: return prim_qsym(args[0], lc);
      case 23: return prim_now(lc);
    }
    return null;
  }
  ...
  Object prim_hexw(Object arg1, Object arg2, LContext lc){
    String s = Long.toHexString(Logo.aLong(arg1,lc)&0xffffffffl);
